...
describe('GET /api/v1/todos/:id', () => {
  ...
  it('responds with an invalid ObjectId error', (done) => {
    request(app)
      .get(`/api/v1/todos/dadasdadaddfka`)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
      // .expect(404, done)
      .expect(422)
  ...
  it('responds with a not found error', (done) => {
    request(app)
      .get(`/api/v1/todos/insert-document-id`)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
      .expect(404, done)
  });
...
describe('PUT /api/v1/todos/:id', () => {
  it('responds with an invalid ObjectId error', (done) => {
    request(app)
      .put(`/api/v1/todos/dadasdadaddfka`)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
      // .expect(404, done)
      .expect(422)
  ...
  it('responds with a not found error', (done) => {
    request(app)
      .put(`/api/v1/todos/insert-document-id`)
      .set('Accept', 'application/json')
      .send({
        content: 'Learn TypeScript',
        done: true,
...
describe('DELETE /api/v1/todos/:id', () => {
  it('responds with an invalid ObjectId error', (done) => {
    request(app)
      .delete(`/api/v1/todos/dadasdadaddfka`)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
      // .expect(404, done)
      .expect(422)
  ...
  it('responds with a not found error', (done) => {
    request(app)
      .delete(`/api/v1/todos/insert-document-id`)
      .set('Accept', 'application/json')
      .expect('Content-Type', /json/)
      .expect(404, done)
  });
